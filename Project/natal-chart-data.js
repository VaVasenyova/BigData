...
function calculateNatalChart(birthDate, birthTime) {
    console.log('Calculating natal chart for date:', birthDate, 'time:', birthTime);
    ...
    planets.forEach(planet => {
        try {
            ...
            console.log(`Planet ${planet.name}: degree ${degree}, sign ${zodiacInfo.sign.name}`);
        } catch (error) {
    ...
    if (birthTime) {
        try {
            ...
            console.log('Ascendant:', natalData.ascendant);
        } catch (error) {
